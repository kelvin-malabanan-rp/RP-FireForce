...
export const usePushNotifications = () => {
    ...
    useEffect(() => {
        const sub = Notifications.addNotificationReceivedListener(async (notification) => {
            ...
            // ✅ CLIENT ONLY LOGS - NO SENDING
            if (notificationType === 'incident_alert') {
                console.log('[push] 🔔 New incident alert received - reminders handled by backend');
            } else if (notificationType === 'auto_reminder') {
                console.log('[push] ⏰ Reminder notification received from backend');
            } else if (notificationType === 'escalation') {
                console.log('[push] 🚨 Escalation notification received from backend');
            }
        });
