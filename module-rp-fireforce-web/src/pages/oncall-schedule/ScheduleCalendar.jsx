              ...
              {schedule && schedule.assignment && (
                <div className="space-y-1">
                  {schedule.assignment.primary && (
                    <div className="text-xs bg-green-100 text-green-800 px-2 py-1 rounded font-medium truncate border border-green-200">
                      {schedule.assignment.primary.firstName}
                    </div>
                  )}
                  {schedule.assignment.backup && (
                    <div className="text-xs bg-blue-100 text-blue-800 px-2 py-1 rounded font-medium truncate border border-blue-200">
                      {schedule.assignment.backup.firstName}
                    </div>
                  )}
                  {schedule.assignment.escalation && schedule.assignment.escalation.length > 0 && (
                    <div className="text-xs bg-orange-100 text-orange-800 px-2 py-1 rounded font-medium truncate border border-orange-200">
